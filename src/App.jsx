    ...
    try {
      ...
      if (!apiKey) {
        setMessages(prev => [...prev, {
          role: 'assistant',
          content: "⚠️ API key not found.\n\nTo fix:\n1. Go to vercel.com → your project\n2. Settings → Environment Variables\n3. Key: VITE_ANTHROPIC_KEY\n4. Value: your sk-ant-... key\n5. Tick ALL 3 environments ✅\n6. Save → Redeploy"
        }]);
        setAiLoading(false);
        return;
      }
      ...
      if (data.error) {
        ...
        let msg = `❌ API Error: ${data.error.message}`;
        if (t === 'authentication_error') msg = "❌ Invalid API key.\n\nFix: In Vercel → Settings → Environment Variables, make sure VITE_ANTHROPIC_KEY starts with sk-ant- and has no extra spaces. Then Redeploy.";
        else if (t === 'rate_limit_error') msg = "⏳ Rate limit hit. Wait 30 seconds and try again.";
        else if (t === 'insufficient_quota') msg = "💳 No credits left. Add credits at console.anthropic.com → Billing.";
